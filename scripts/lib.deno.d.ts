...
// this file is a stipped down version of lib.deno.d.ts from 1.42.4 
// original lib.deno.d.ts re-defines web apis, but we want to avoid interfering with the rest of the typings
// and use typescript's lib.dom.d.ts instead
