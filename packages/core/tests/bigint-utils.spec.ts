...
import { bigIntToBuffer, bufferToBigInt } from '../src/utils/bigint-utils'
...
describe('bigIntToBuffer', () => {
    ...
    it('should handle writing to LE', () => {
        ...
        expect([
            ...bigIntToBuffer(bigInt('9341376580368336208'), 8, true),
        ]).eql([...Buffer.from('81A33C81D2020550', 'hex').reverse()])
    })
})
